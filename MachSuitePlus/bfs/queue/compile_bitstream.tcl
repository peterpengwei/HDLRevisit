...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/bfs/queue/input.data /curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/bfs/queue/check.data workload.xclbin"
