...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/MachSuite/bfs/bulk/input.data /curr/pengwei/ISCA17/HDLRevisit/MachSuite/bfs/bulk/check.data workload.xclbin"
