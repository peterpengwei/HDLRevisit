...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/sort/radix/input.data /curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/sort/radix/check.data workload.xclbin"
