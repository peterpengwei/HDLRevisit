...
void run_benchmark( void *vargs, cl_context& context, cl_command_queue& commands, cl_program& program, cl_kernel& kernel ) {
  ...
  cl_mem input_buffer = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(args->input), NULL, NULL);
  ...
  err |= clEnqueueWriteBuffer(commands, input_buffer, CL_TRUE, 0, sizeof(args->input), args->input, 0, NULL, NULL);
  if (err != CL_SUCCESS)
  {
