...
add_files -kernel [get_kernels workload] "aes.c"
...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/aes/aes_doublebuf_para_comm/input.data /curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/aes/aes_doublebuf_para_comm/check.data workload.xclbin"
