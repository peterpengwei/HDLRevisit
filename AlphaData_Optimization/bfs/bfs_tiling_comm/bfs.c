...
#pragma HLS INTERFACE s_axilite port=return bundle=control
	...
	level[0] = local_edge_begin[0] > local_edge_begin[N_NODES-1] ? 0:N_NODES-1;
	level[N_NODES-1] = local_edge_end[0] > local_edge_end[N_NODES-1] ? 0:N_NODES-1;
	level_counts[0] = local_dst[0] > local_dst[N_NODES-1] ? 0:N_NODES-1;
	level_counts[N_LEVELS-1] = local_dst[0] > local_dst[N_NODES-1] ? 0:N_NODES-1;
