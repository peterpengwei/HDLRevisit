...
create_solution -name bfs -dir . -force
...
add_files "../../common/support.h bfs.h"
set_property file_type "c header files" [get_files "support.h"]
set_property file_type "c header files" [get_files "bfs.h"]

# Kernel Definition
create_kernel workload -type c
add_files -kernel [get_kernels workload] "bfs.c"
add_files -kernel [get_kernels workload] "bfs.h"
...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/bfs/bfs_baseline_comm/input.data /curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/bfs/bfs_baseline_comm/check.data workload.xclbin"
