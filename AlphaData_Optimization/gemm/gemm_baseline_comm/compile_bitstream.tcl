...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/gemm/gemm_baseline_comm/input.data /curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/gemm/gemm_baseline_comm/check.data workload.xclbin"
