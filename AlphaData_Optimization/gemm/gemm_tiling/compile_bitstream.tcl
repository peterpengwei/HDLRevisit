...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/gemm/gemm_baseline/input.data /curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/gemm/gemm_baseline/check.data workload.xclbin"
