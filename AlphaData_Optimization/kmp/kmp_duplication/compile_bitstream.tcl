...
create_solution -name kmp -dir . -force
...
add_files "../../common/support.h kmp.h"
set_property file_type "c header files" [get_files "support.h"]
set_property file_type "c header files" [get_files "kmp.h"]

# Kernel Definition
create_kernel workload -type c
add_files -kernel [get_kernels workload] "kmp.cpp"
add_files -kernel [get_kernels workload] "kmp.h"
...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/kmp/kmp_baseline/input.data /curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/kmp/kmp_baseline/check.data workload.xclbin"
