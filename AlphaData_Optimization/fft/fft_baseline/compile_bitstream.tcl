...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/fft/fft_baseline/input.data /curr/pengwei/ISCA17/HDLRevisit/AlphaData_Optimization/fft/fft_baseline/check.data workload.xclbin"
