...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/md/grid/input.data /curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/md/grid/check.data workload.xclbin"
