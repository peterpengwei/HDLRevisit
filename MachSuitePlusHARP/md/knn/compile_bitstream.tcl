...
create_solution -name md -dir . -force
...
add_files "../../common/support.h md.h"
set_property file_type "c header files" [get_files "support.h"]
set_property file_type "c header files" [get_files "md.h"]

# Kernel Definition
create_kernel workload -type c
add_files -kernel [get_kernels workload] "md.c"
add_files -kernel [get_kernels workload] "md.h"
add_files -kernel [get_kernels workload] "../../common/support.h"
set_property -name kernel_flags -value "-I/curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/common" -objects [get_kernels workload]
...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/md/knn/input.data /curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/md/knn/check.data workload.xclbin"
