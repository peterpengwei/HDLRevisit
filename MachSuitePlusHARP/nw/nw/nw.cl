...
__kernel void 
__attribute__((task))
workload(__global char * restrict SEQA, __global char * restrict SEQB,
             __global char * restrict alignedA, __global char * restrict alignedB) {
    __local int M[(ALEN+1)*(BLEN+1)];
    __local char ptr[(ALEN+1)*(BLEN+1)];
