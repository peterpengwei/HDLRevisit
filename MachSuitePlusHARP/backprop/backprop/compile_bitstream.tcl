...
create_solution -name backprop -dir . -force
...
add_files -kernel [get_kernels workload] "backprop.c"
add_files -kernel [get_kernels workload] "backprop.h"
...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/backprop/backprop/input.data /curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/backprop/backprop/check.data workload.xclbin"
