...
__kernel void 
__attribute__((task))
workload( __global tok_t * restrict obs, __global prob_t * restrict init, __global prob_t * restrict transition, __global prob_t * restrict emission, __global state_t * restrict path )
{
