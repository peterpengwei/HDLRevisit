...
run_emulation -flow cpu -args "/curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/sort/merge/input.data /curr/pengwei/ISCA17/HDLRevisit/MachSuitePlus/sort/merge/check.data workload.xclbin"
